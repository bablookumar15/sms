...
<script src="${pageContext.request.contextPath}/resources/js/YouTubePopUp.jquery.js"></script>
...
<script src="${pageContext.request.contextPath}/resources/js/jshashtable-2.1_src.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/jquery.numberformatter-1.2.3.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/tmpl.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/jquery.dependClass-0.1.js"></script> 
